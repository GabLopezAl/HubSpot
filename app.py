...
# --- CONFIGURACIÓN (REVISA ESTOS NOMBRES) ---
...
def vincular_equipo(ticket_id, sn_value):
    ...
    if resp.status_code != 200:
        ...
        print(f"❌ ERROR 400 DE HUBSPOT: {resp.text}")
        return
    ...
    if results:
        ...
        if r_assoc.status_code in [200, 201]:
            print(f"✅ Éxito: Ticket {ticket_id} unido a Equipo {equipo_id}")
    else:
        print(f"⚠️ No se halló equipo con SN: {sn_value}")
